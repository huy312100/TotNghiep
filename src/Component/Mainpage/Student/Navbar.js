    ...
    const renderUserBox = () => (
        <div className="action-box">
            ...
            <Link to="/profile" className="user-link" style={{ textDecoration: 'none' }}>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 28 26" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="mr-50 feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                <div >Thông tin cá nhân</div>
            </Link>
            <Link to="/setting" className="user-link" style={{ textDecoration: 'none' }}>
            ...
            <nav className="navbar navbar-light fixed-top">
                ...
                <div style={{ marginLeft: "10px" }} className="navbar-brand" href="/home">
                    <span className="side-img">
                        <svg type="button" onClick={() => dispatch(storeOpensidebar(!open))} xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-list" viewBox="0 0 16 16">
